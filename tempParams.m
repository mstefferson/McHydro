...
%trial master
trialmaster.tind       = 9; % trial indicator
trialmaster.runstrtind = 1; % run indicator
trialmaster.nt         = 12; % number of trials

%key parameters and constants
params.bind_energy_vec = [-20 -10 -5 -4 -3 -2 -1 -0.1 0];
params.ffrac_obst_vec= [ 0.1 ]; %filling fraction of obstacles
params.size_obst = [1:2:15]; % size of obst. prgm forces it ot be odd
...
params.tr_bnd_hop_energy = 0; %barrier height to sliding while bound, in kT
