  ...
  if nparams > 1
    ...
    parfor j=1:nparams
      ...
      pvec=[params.ffrac_tracer, ...
        params.tr_unbnd_diff, params.tr_bnd_diff,...
        ffrac_obst, bind_energy, size_obst]; %parameter vector
      
      filestring=['unD',num2str(params.tr_unbnd_diff),...
        '_bD',num2str(params.tr_bnd_diff,'%.2f'),...
        '_bind',num2str(bind_energy),...
        '_fo',num2str(ffrac_obst,'%.2f'),'_so',num2str(size_obst),...
        '_ft',num2str(params.ffrac_tracer,'%.2f'),'_st',num2str(const.size_tracer),...
        '_oe',num2str(modelopt.obst_excl),'_ng',num2str(const.n_gridpoints),...
        '_dim', num2str(const.dim),'_nt',num2str(const.ntimesteps),...
