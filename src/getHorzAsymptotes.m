...
function [asymInfo, binInfo] = getHorzAsymptotes( x, y, errY, ...
  threshold, numBins, binSpacingType, plotFlag )
...
slopeAsym = zeros(1, numAsymptotes); % slope of fit in asymptote range
yInterAsym = zeros(1, numAsymptotes); % y intercept of fit in asymptote range
xCenterAsym = zeros(1, numAsymptotes); % x value at center of asymptote range
xSmallestAsym = zeros(1, numAsymptotes); % smallest x value in asymptote range
...
asymInfo.xSmallestAsym  = xSmallestAsym;
...
asymInfo.maxSlopeInterceptVal = maxSlopeInterceptVal;
% bin info
